  ...
  <el-container class="app-layout">
    <el-header class="layout-header">
      <div class="header-left">
        ...
        <h2 class="header-title">C语言自动批阅系统 · 教师</h2>
      </div>
    ...
    <el-container class="layout-body">
      <el-aside :class="['layout-sidebar', { collapsed: sidebarCollapsed }]">
        <el-menu :default-active="$route.path" router :collapse="sidebarCollapsed">
          <el-menu-item index="/teacher/dashboard"><span>首页</span></el-menu-item>
          <el-menu-item index="/teacher/courses"><span>课程管理</span></el-menu-item>
          <el-menu-item index="/teacher/assignments"><span>作业管理</span></el-menu-item>
          <el-menu-item index="/teacher/problems"><span>题库管理</span></el-menu-item>
          <el-menu-item index="/teacher/grading-review"><span>批阅审核</span></el-menu-item>
          <el-menu-item index="/teacher/analytics"><span>学情分析</span></el-menu-item>
          <el-menu-item index="/teacher/announcements"><span>公告管理</span></el-menu-item>
          <el-menu-item index="/teacher/score-export"><span>成绩导出</span></el-menu-item>
          <el-menu-item index="/teacher/profile"><span>个人设置</span></el-menu-item>
        </el-menu>
      </el-aside>
