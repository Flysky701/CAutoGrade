  ...
  <el-container class="app-layout">
    <el-header class="layout-header">
      <div class="header-left">
        ...
        <h2 class="header-title">C语言自动批阅系统 · 管理</h2>
      </div>
    ...
    <el-container class="layout-body">
      <el-aside :class="['layout-sidebar', { collapsed: sidebarCollapsed }]">
        <el-menu :default-active="$route.path" router :collapse="sidebarCollapsed">
          <el-menu-item index="/admin/dashboard"><span>系统概览</span></el-menu-item>
          <el-menu-item index="/admin/users"><span>用户管理</span></el-menu-item>
          <el-menu-item index="/admin/config"><span>系统配置</span></el-menu-item>
          <el-menu-item index="/admin/logs"><span>操作日志</span></el-menu-item>
        </el-menu>
      </el-aside>
