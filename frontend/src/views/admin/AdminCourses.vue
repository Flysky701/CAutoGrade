...
import { ElMessage, ElTable, ElTableColumn, ElTag, ElButton, ElPopconfirm } from 'element-plus';
...
<template>
  <div>
    <div class="page-header">
      <h2>课程管理</h2>
      <span style="color:#909399;font-size:14px">共 {{ courses.length }} 门课程 · 课程由教师创建，管理员可查看和删除</span>
    </div>
